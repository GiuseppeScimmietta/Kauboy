...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','tryPLY.py',59),
  ('statement -> expression','statement',1,'p_statement_expr','tryPLY.py',63),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','tryPLY.py',67),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','tryPLY.py',68),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','tryPLY.py',69),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','tryPLY.py',70),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','tryPLY.py',77),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','tryPLY.py',81),
  ('expression -> NUMBER','expression',1,'p_expression_number','tryPLY.py',85),
  ('expression -> NAME','expression',1,'p_expression_name','tryPLY.py',89),
]
